...
countries.each do |country|
  db_country = Country.where(:country_code => country[:code], :name => country[:name]).first_or_create
end

alert_types = ['Crime & Safety', 'Roads & Trails', 'Social Events', 'Govt. & Oversight Events', 
               'Elections', 'General Alerts', 'Laws & Regulations']
...
admin_password = admin_username + admin_password
