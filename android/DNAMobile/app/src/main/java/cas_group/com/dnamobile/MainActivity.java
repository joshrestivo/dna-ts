...
//                selectLeftMenuItem(position, false);
    ...
    protected void onInitData() {
        ...
        ArrayList <LeftMenuItem>menuItems = new ArrayList<>();

        menuItems.add(new LeftMenuItem("Home", ContextCompat.getDrawable(getBaseContext(),R.drawable.ic_home_black_36dp)));
        menuItems.add(new LeftMenuItem("Upcoming Events",ContextCompat.getDrawable(getBaseContext(),R.drawable.ic_event_black_36dp)));
        menuItems.add(new LeftMenuItem("Request Service",ContextCompat.getDrawable(getBaseContext(),R.drawable.ic_assignment_black_36dp)));
        menuItems.add(new LeftMenuItem("Location Info",ContextCompat.getDrawable(getBaseContext(),R.drawable.ic_info_outline_black_36dp)));
